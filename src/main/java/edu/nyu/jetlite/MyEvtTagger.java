...
//import edu.nyu.jetlite.NeuralExtractor;
//
///**
// *  Identify ACE events.
// *  <p>
...
// */
//
//public class MyEvtTagger extends Annotator {
//
//    // the file containing the MaxEnt model
//    String modelFileName;
//
//    // the MaxEnt model
//    NeuralExtractor model;
//
//    /**
...
//     */
//
//    public MyEvtTagger (Properties config) throws IOException {
//        modelFileName = config.getProperty("NeuralExtractor.model.fileName");
//    }
//
//    /**
...
//        p.setProperty("NeuralEventTagger.model.fileName", mfn);
...
//        PrintWriter eventWriter = new PrintWriter (new FileWriter ("neural.events"));
//        int docCount = 0;
//        String line;
